...
file_path = pathlib.Path(
    "../../data/6.analysis_results/custom_aggregated_levene_test_results.csv"
).resolve(strict=True)
...
variance_df_path = pathlib.Path(
    "../../data/6.analysis_results/custom_aggregated_variance_results_each_feature.csv"
).resolve(strict=True)
...
final_enrichment_half_baked_df.to_csv(
    "../../data/6.analysis_results/custom_aggregated_feature_group_enrichment_half_baked.csv",
    index=False,
)
