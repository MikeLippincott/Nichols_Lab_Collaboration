...
plt.savefig("../figures/mean_aggregated/feature_group_enrichment_heatmap.png")
plt.show()
...
# label the colorbar
plt.savefig(
    "../figures/mean_aggregated/feature_group_enrichment_heatmap_permutated_labels.png"
)
plt.show()
