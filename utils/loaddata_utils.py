...
def create_loaddata_illum_csv(
    ...
    print(
        f"The {path_to_output.name} CSV file has been removed as it does not contain the IC functions."
    )
...
def edit_loaddata_csv(path_to_loaddata_csv: pathlib.Path):
    ...
    print(
        f"{path_to_loaddata_csv.name} has been edited! All rows have been removed except rows with last z-plane. The remaining rows paths are updated."
    )
...
def split_loaddata_csv_by_col(
    ...
    print(
        f"{path_to_loadata.name} has been split into {first_csv_name}.csv and {second_csv_name}.csv!"
    )
...
def split_loaddata_csv_by_row(
    ...
    print(
        f"{path_to_loaddata.name} has been split into {first_csv_name}.csv and {second_csv_name}.csv!"
    )
